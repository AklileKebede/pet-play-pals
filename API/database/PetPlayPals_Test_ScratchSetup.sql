...
insert into pets(pet_name, birthday, sex, pet_type_id, pet_breed, color, bio) values ('Pippin', '01-15-2020', 'M', 2, 'American Shorthair', 'Grey and White', 'pippin is dumb');
insert into pets(pet_name, birthday, sex, pet_type_id, pet_breed, color, bio) values ('Teddy', '01-15-2011', 'M', 1, 'Pitbull', 'Golden', 'Teddy is cuddly');
...
insert into user_pet(user_id, pet_id) Values(3,6);
