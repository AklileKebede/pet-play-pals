	...
	methods: {
		...
		async initMap() {
			...
			autocomplete.addListener("place_changed", () => {
				...
				this.$store.commit("SET_CURRENT_MAP_MARKER",{lat:place.geometry.location.lat(),lng:place.geometry.location.lng(),address:place.formatted_address,name:place.name});
